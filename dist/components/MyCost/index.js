...
var MyInput = function (_BaseComponent) {
  ...
  function MyInput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MyInput.__proto__ || Object.getPrototypeOf(MyInput)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "value", "files", "preview", "data"], _this.handleChange = function (event) {
      _this.setState({
...
MyInput.$$events = ["handleChange", "onChangeImagePicker", "onFailImagePicker", "onImageClick"];
MyInput.propTypes = {
